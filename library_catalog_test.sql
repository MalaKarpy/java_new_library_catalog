...
SELECT pg_catalog.setval('authors_id_seq', 123, true);
...
COPY books (id, title, book_isbn) FROM stdin;
\.
...
SELECT pg_catalog.setval('books_authors_id_seq', 21, true);
...
SELECT pg_catalog.setval('books_id_seq', 78, true);
...
SELECT pg_catalog.setval('checkouts_id_seq', 12, true);
...
COPY copies (id, book_id, copy_isbn) FROM stdin;
\.
...
SELECT pg_catalog.setval('copies_id_seq', 101, true);
...
SELECT pg_catalog.setval('patrons_id_seq', 114, true);
